...
const getScanTypeIconPath = (scanType: string) => path.join(PATH_TO_SCAN_TYPE_ICONS, `${scanType}.png`);

export const getSeverityIconPath = (severityFirstLetter: string) => path.join(PATH_TO_SEVERITY_ICONS, `${severityFirstLetter}.png`);
